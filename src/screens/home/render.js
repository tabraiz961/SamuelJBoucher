...
export const ViewHome = ({
  ...
  return (
    <Container>
      <View style={[{height:Devices.sH("30%"), borderBottomRightRadius:70,overflow: 'hidden'}]}>
        <ImageBackground  style={{width: "100%", height: Devices.sH("30%"), borderBottomRightRadius:70, overflow: 'hidden',  elevation: 1, backgroundColor: 'rgba(24, 129, 36, 0.9)', }} imageStyle= {{opacity:0.8}} resizeMode="cover" source={Assets.header_background} >
          <CHeader 
            style={{ backgroundColor:'transparent',  top:30, elevation: 0, overflow: 'hidden', paddingLeft: 15, paddingRight: 15 }} 
            props={props}
            titleComponent={
              <View style={[cStyles.row_justify_center, cStyles.row_align_center, cStyles.flex_full]}>
                <Pressable  style={[{elevation: 3,width: '100%',height: 35, flexDirection: 'row', flex: 1} ]} onPress={onFunction.onFocusSearch}>
                  <View
                    style={[
        ...
        (state._about_author == 4 ? 
          <>
            <View style={[{marginLeft:20, marginTop:20}]}>
              <Text style={[{color: Colors.YELLOW_COLOR, fontWeight:"600", fontFamily: Devices.zsHeadlineBold, fontSize:Devices.fS(20)}, ]}>Videos</Text>
            </View>
            <ScrollView>
              <View style={[{flex:1,  margin:20}]}>
                <View style={[cStyles.row_align_center]}>
                  <View style={[ cStyles.flex_full, {width: Devices.width-50, height: 120, borderRadius:5}]}>
                    <Video source={{uri: "https://sample-videos.com/video123/mp4/360/big_buck_bunny_360p_10mb.mp4"}}   // Can be a URL or a local file.
                      ...
                      controls={true}
                      paused={true}
                      style={[{  height: 120, flex:1, borderRadius:5 }]}
                      resizeMode='stretch'
      ...
      : 
        (<>
          <View style={[cStyles.flex_wrap,cStyles.column_align_start, cStyles.column, {height:Devices.sH("70%")}]}>
            <Pressable onPress={onFunction.onPressOverview} style={[{marginHorizontal:17, marginVertical:10}]}>
              <View style={[{backgroundColor:'#AF8400', height: Devices.sH("33%"), width:Devices.sW("40%"),  borderRadius: 10}, cStyles.column_justify_between]}>
                <Text style={[cStyles.row_align_start,cStyles.txt_title_button, {flex: 1, flexWrap: 'wrap',width:'auto', height: '30%', fontSize:Devices.fS(20)}, cStyles.ml_15, cStyles.mt_10]}>Book {"\n"}Overview</Text>
                <Image style={[{width: "110%", height: '70%', position:'absolute', bottom:0},cStyles.row_align_end]} source={Assets.book_overview} />
              </View>
            </Pressable>
            
            <Pressable onPress={onFunction.onPressVideos}  style={[{marginHorizontal:17, marginVertical:10}]}>
              <View style={[{backgroundColor:'#003B3F', height: Devices.sH("22%"), width:Devices.sW("40%"), borderRadius: 10, paddingLeft: 20}, cStyles.column_justify_between]}>
                <Image style={[{width: 120.63, height: 69.86},cStyles.row_align_start]} source={Assets.video_image} />
                <Text style={[cStyles.txt_title_button,cStyles.mt_10, {flex: 1, flexWrap: 'wrap',width:100, fontSize:Devices.fS(20)}]}>Videos</Text>
              </View>
            </Pressable>
            
            <Pressable onPress={onFunction.onPressAbout} style={[{marginHorizontal:17, marginVertical:10}]}> 
              <View style={[{backgroundColor:'#175700', height: Devices.sH("22%"), width:Devices.sW("40%"),  borderRadius: 10}, cStyles.column_justify_between]}>
                <Text style={[cStyles.row_align_start,cStyles.txt_title_button, {flex: 1, flexWrap: 'wrap',width:80, fontSize:Devices.fS(20)}, cStyles.ml_15, cStyles.mt_10]}>About The Author</Text>
                <Image  style={[{width: '50%', height: '110%',position: 'absolute', right: -3, bottom:0},cStyles.row_align_end]} source={Assets.about_author} />
              </View>
            </Pressable>
  
            <Pressable  onPress={() => props?.navigation.jumpTo('Service')} style={[{marginHorizontal:17, marginVertical:10}]}> 
              <View style={[{backgroundColor:'#690001', height: Devices.sH("33%"), width:Devices.sW("40%"),  borderRadius: 10}, cStyles.column_justify_between]}>
                ...
                <Image style={[{width: '80%', height: '60%',position: 'absolute', right: -10, bottom:0},cStyles.row_align_end]} source={Assets.products_image} />
              </View>
            </Pressable>
          </View>
