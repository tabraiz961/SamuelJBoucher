    ...
    <Container>
      ...
      <Content>
        ...
        <FlatList contentContainerStyle={[styles.con_list, { marginHorizontal: Devices.pH(layoutWidth.width) }]}
          ...
          ListHeaderComponent={<CText style={[cStyles.txt_title_group, {color: Colors.NEW_THEME}]} i18nKey={"information"} />}
        />
        ...
        <FlatList contentContainerStyle={[styles.con_list, { marginHorizontal: Devices.pH(layoutWidth.width) }]}
          ...
          ListHeaderComponent={<CText style={[cStyles.txt_title_group, cStyles.pt_10, {color: Colors.NEW_THEME}]} i18nKey={"settings"} />}
        />
